    ...
    <header style={{
      ...
      <div className="header-inner" style={{
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: "1.2rem", textDecoration: "none" }}>
          ...
          <span className="header-mello" style={{
            fontFamily: "var(--font-display, 'Bebas Neue', sans-serif)",
            fontSize: "2.8rem", letterSpacing: ".12em",
            color: "#f5f5f5", WebkitFontSmoothing: "antialiased", lineHeight: 1,
          }}>MELLO</span>
        </Link>
