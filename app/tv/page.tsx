    ...
    <main style={{
      ...
      <section style={{
        ...
        <h1 style={{
          ...
          color: "#f5f5f5", marginBottom: ".5rem",
        ...
        <p style={{
          ...
          letterSpacing: ".05em", position: "relative", zIndex: 1,
        }}>
      ...
      {/* ── STREAM ── */}
      <section style={{ padding: "3rem 3rem 0", display: "flex", justifyContent: "center" }}>
        <div style={{
          width: "100%",
          maxWidth: "800px",
          aspectRatio: "16/9",
      ...
      <section style={{
        ...
        <div>
          <h2 style={{
            ...
            Highlights<br />
            <span style={{ color: "#0d9488" }}>Coming Soon</span>
          </h2>
        ...
        <div style={{
          ...
          {["Spielclips", "Events", "Interviews", "Behind the Scenes"].map((label, i) => (
            <div key={i} style={{
              ...
              <div style={{
                fontFamily: "var(--font-display, 'Bebas Neue', sans-serif)",
                fontSize: "1.1rem", letterSpacing: ".08em",
                color: "#333333", marginBottom: ".3rem",
              }}>Bald</div>
              <div style={{
                fontSize: ".85rem", color: "#444444",
              }}>{label}</div>
            </div>
          ))}
        </div>
