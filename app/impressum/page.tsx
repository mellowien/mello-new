export default function ImpressumPage() {
    ...
    <main style={{
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .impr-label   { padding-top: 0 !important; }
        }
      `}</style>
      ...
      <section className="impr-content" style={{ padding: "4rem 3rem", maxWidth: "900px" }}>
        {sections.map((s, i) => (
          <div key={i} className="impr-row" style={{
            ...
            <div className="impr-label" style={{
              fontFamily: "var(--font-display, 'Bebas Neue', sans-serif)",
  ...
  const sections = [
    {
      title: "Verein",
      content: "Fußballclub Mello Wien (FC Mello Wien)",
    },
    {
      title: "ZVR-Zahl",
      content: "1231202907",
    ...
    {
      title: "Rechtsform",
      content: "Gemeinnütziger, eingetragener Verein nach österreichischem Vereinsgesetz (VerG 2002)",
    },
    {
      title: "Vereinssitz",
      content: "1020 Wien\nNordbahnstraße 47\nÖsterreich",
    },
    {
      ...
      content: "Der Verein wird nach außen vertreten durch den Obmann:\nDaniel Rezai\n\nSchriftliche Ausfertigungen benötigen die Unterschrift des Obmanns und des/der Schriftführer/in.\nIn finanziellen Angelegenheiten: Obmann und Kassier/in.",
      highlight: "Daniel Rezai",
    },
    {
      title: "Vereinszweck",
      content: "Förderung des Sports, insbesondere Fußball, sowie Aufbau eines urbanen, modernen Multisportvereins.",
    },
    {
      title: "Haftungsausschluss",
      content: "Alle Inhalte dieser Website wurden sorgfältig erstellt. Für Richtigkeit, Vollständigkeit und Aktualität kann keine Haftung übernommen werden. Für Inhalte externer Links ist ausschließlich der jeweilige Betreiber verantwortlich.",
    },
    {
      title: "Urheberrecht",
      content: "Sämtliche Inhalte (Texte, Bilder, Grafiken, Medien) unterliegen dem Urheberrecht. Jede Nutzung außerhalb des Urheberrechts bedarf der schriftlichen Zustimmung.",
    },
  ];
  ...
  return (
    <main style={{
      ...
      {/* ── CONTENT ── */}
      <section style={{ padding: "4rem 3rem", maxWidth: "900px" }}>
        {sections.map((s, i) => (
          <div key={i} style={{
            display: "grid",
            ...
            <div style={{
              fontFamily: "var(--font-display, 'Bebas Neue', sans-serif)",
              fontSize: "1rem", letterSpacing: ".1em",
              color: "#0d9488", paddingTop: ".1rem",
            }}>
              {s.title}
            </div>
            <div style={{ fontSize: ".95rem", color: "#888888", lineHeight: 1.8 }}>
              {s.title === "Kontakt" ? null : s.content.split("\n").map((line, j) => (
                <span key={j}>
                  {line === "Daniel Rezai"
                    ? <span style={{ color: "#f5f5f5", fontWeight: 500 }}>{line}</span>
                    : line}
        ...
        <div style={{
          ...
          <div style={{ fontSize: ".95rem", color: "#888888", lineHeight: 1.8 }}>
            E-Mail:{" "}
            <a href="mailto:kontakt@mellowien.at" style={{ color: "#0d9488", textDecoration: "none" }}>
              kontakt@mellowien.at
            </a>
            <br />
            Website:{" "}
            <a href="https://mellowien.at" style={{ color: "#0d9488", textDecoration: "none" }}>
              mellowien.at
            </a>
          </div>
        </div>
