...
export default function Kontakt() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        alert(`❌ Es gab ein Problem beim Senden.${data?.error ? `\n\n${data.error}` : ""}`);
        return;
      }
      setShowPopup(true);
      ...
      <section className="kontakt-hero" style={{
        ...
        <div style={{ maxWidth: "800px", position: "relative", zIndex: 1 }}>
          ...
          <p style={{
            ...
            color: "#888888", lineHeight: 1.8, whiteSpace: "nowrap",
          }}>
            Fragen, Ideen oder Kooperationen? Wir freuen uns über jede Nachricht.
          </p>
        </div>
      </section>
      ...
      <section className="kontakt-form" style={{
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="text" name="website" value={formData.website}
            onChange={handleChange} autoComplete="off" tabIndex={-1}
            style={{ display: "none" }} />
        ...
        <div style={{ paddingTop: "1rem" }}>
          <h2 style={{
            ...
            letterSpacing: ".02em", color: "#f5f5f5",
            marginBottom: "1.5rem",
          }}>
            Schreib uns
          </h2>
          <p style={{ color: "#666666", fontSize: ".95rem", lineHeight: 1.8, marginBottom: "2rem" }}>
            Ob du mitspielen, mitgestalten oder einfach mehr erfahren möchtest — wir melden uns persönlich bei dir.
          </p>

          <div style={{ borderTop: "1px solid #1a1a1a", paddingTop: "2rem" }}>
            <p style={{ fontSize: ".7rem", letterSpacing: ".2em", textTransform: "uppercase", color: "#555555", marginBottom: ".5rem" }}>
              E-Mail
            </p>
            <a href="mailto:kontakt@mellowien.at" style={{
      ...
      {showPopup && (
        <div onClick={() => setShowPopup(false)} style={{
          ...
          <div onClick={(e) => e.stopPropagation()} style={{
            ...
            <h2 style={{
              fontFamily: "var(--font-display, 'Bebas Neue', sans-serif)",
              fontSize: "2.5rem", letterSpacing: ".05em",
              color: "#0d9488", marginBottom: "1rem",
            }}>Nachricht verschickt</h2>
            <p style={{ color: "#888888", lineHeight: 1.7, marginBottom: "2rem" }}>
